...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: "Allows you to enter the trips you take on public transit during your everyday life in order to see visual estimates of the positive impact, both environmentally and financial, that choosing public transportation has.",
    ...
    },
    {
        ...
        description: "Feature built for the popular UMN grades tool, GopherGrades. The hall plotter feature allows students to visualize the pathing of their class schedule while registering for classes. It works as part of the Chrome Extension version of GopherGrades.",
        tools: ["JavaScript"],
        images: null,
    ...
    },
    {
        ...
        description: "Me and a partner redesigned the website for a local nonprofit, Sisters' Camelot. We did a couple rounds of user research and testing to make sure we were meeting the needs of the users. In the end, we created a few high fidelity mockups that were a step up in user experience.",
    ...
    },
    {
        ...
        description: "A Monday.com app that I built for a client. It adds functionality to \"date\" columns in Monday boards that were previously lacking.",
    ...
    },
    {
        ...
        description: "Designed a tracking app for runners from start to finish with a team of 5. A couple rounds of user research and testing were done to make sure we were meeting the needs of the users.",
        tools: ["Figma", "User Research"],
    ...
    },
    {
        ...
        description: "A nutritional tracker that implements user accounts and food recommendations based on criteria.",
        tools: ["Python", "SQLite"],
        images: null,
